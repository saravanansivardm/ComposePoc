...
fun Promotions() {
    LazyRow(
        ...
        item {
            PromotionItem(
                imagePainter = painterResource(id = R.drawable.ic_calendar),
                title = "Fruit",
                subtitle = "Start @",
                header = "$1",
...
fun CategorySection() {
    Column(Modifier.padding(horizontal = 16.dp)) {
        ...
        Row(
            ...
            CategoryButton(
                text = "Dairy",
                icon = painterResource(id = R.drawable.ic_bg_lecture),
...
fun BestSellerItems() {
    LazyRow(
        ...
        item {
            BestSellerItem(
                imagePainter = painterResource(id = R.drawable.ic_ellipse),
        ...
        item {
            BestSellerItem(
                imagePainter = painterResource(id = R.drawable.ic_drop_down_black),
                title = "Apple",
                price = "2.64",
                discountPercent = 5
            )
        ...
        item {
            BestSellerItem(
                imagePainter = painterResource(id = R.drawable.ratingbar),
                title = "Meat",
                price = "4.76",
                discountPercent = 20
            )
